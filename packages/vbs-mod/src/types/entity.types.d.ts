import type { BaseEntityProps } from './base-entity.types.js';
import type { PropertiesRowProps } from './properties-row.types.js';
import type { EdgeProps } from './edge.types.js';
